            ...
            if (fnd.length > 0) {
                ...
                newStream.save(err => {
                    if (err) return res.status(500).send(err);
                        ...
                        ActivityController.addActivity(req.body.host, 'Started streaming with title: ' + req.body.title, 'Created stream');
        ...
        .then(updatedStrm => {
            ...
            UserMdl.findByIdAndUpdate(updatedStrm.host, { kudos: dif, totalStreamTime: strmtime }, { new: true })
                .then(updatedUsr => {
                    ...
                    ActivityController.addActivity(req.body.host, 'Ended stream with title: ' + updatedStrm.title, 'Ended stream');
